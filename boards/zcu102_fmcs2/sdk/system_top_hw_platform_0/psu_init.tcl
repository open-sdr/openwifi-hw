...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01010600
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ps_pl_reset_config_data {
    ...
    mask_write 0XFF0A002C 0xFFFF0000 0xE0000000
    ...
    mask_write 0XFF0A0344 0xFFFFFFFF 0xE0000000
    ...
    mask_write 0XFF0A0348 0xFFFFFFFF 0xE0000000
    ...
    mask_write 0XFF0A0054 0xFFFFFFFF 0xE0000000
    mask_delay 0x00000000 1
