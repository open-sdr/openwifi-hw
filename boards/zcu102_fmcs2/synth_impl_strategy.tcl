...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/fmcomms2_zcu102.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/fmcomms2_zcu102.srcs/utils_1/imports/impl_1" -objects $obj
