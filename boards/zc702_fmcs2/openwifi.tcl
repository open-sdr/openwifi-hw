...
#
# Generated by Vivado on Wed Apr 22 15:52:54 CEST 2020
...
set file "[file normalize "$origin_dir/../../adi-hdl/projects/fmcomms2/zc702/system_constr.xdc"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../adi-hdl/projects/common/zc702/zc702_system_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg484-1 -flow {Vivado Synthesis 2018} -strategy "Flow_AreaOptimized_medium" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg484-1 -flow {Vivado Implementation 2018} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
