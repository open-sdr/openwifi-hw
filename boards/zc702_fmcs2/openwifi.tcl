...
set project_name "openwifi_zc702_fmcs2"
...
set_property -name "board_part" -value "xilinx.com:zc702:part0:1.2" -objects $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../adi-hdl/projects/fmcomms2/zc702/system_constr.xdc"]"\
 "[file normalize "$origin_dir/../../adi-hdl/projects/common/zc702/zc702_system_constr.xdc"]"\
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project (-no_copy_sources specified)
set files [list \
...
set file "$origin_dir/../../adi-hdl/projects/common/zc702/zc702_system_constr.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../../adi-hdl/projects/fmcomms2/zc702/system_constr.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg484-1 -flow {Vivado Synthesis 2017} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg484-1 -flow {Vivado Implementation 2017} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
