...
set _xil_proj_name_ "openwifi_adrv9364z7020"
...
set file "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/adrv9364z7020_constr.xdc"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/adrv9364z7020_constr_lvds.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/ccbob_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2018} -strategy "Performance_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
