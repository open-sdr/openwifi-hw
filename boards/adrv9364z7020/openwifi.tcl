...
set project_name "openwifi_adrv9364z7020"
...
set_msg_config  -ruleid {46}  -id {Vivado 12-1790}  -string {{Evaluation} {features} {should} {NOT} {be} {used} {in} {production} {systems.}}  -new_severity {WARNING}  -source 2
set_msg_config  -ruleid {47}  -id {BD 41-1343}  -new_severity {WARNING}  -source 2
set_msg_config  -ruleid {48}  -id {BD 41-1306}  -new_severity {WARNING}  -source 2
set_msg_config  -ruleid {49}  -id {BD 41-1276}  -severity {CRITICAL WARNING}  -new_severity {ERROR}  -source 2
set_msg_config  -ruleid {50}  -id {IP_Flow 19-3656}  -new_severity {INFO}  -source 2
set_msg_config  -ruleid {51}  -id {IP_Flow 19-4623}  -new_severity {INFO}  -source 2
set_msg_config  -ruleid {52}  -id {IP_Flow 19-459}  -new_severity {INFO}  -source 2
set_msg_config  -ruleid {53}  -id {Place 30-73}  -string {{axi_spi}}  -new_severity {WARNING}  -source 2
set_msg_config  -ruleid {54}  -string {{PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY}}  -new_severity {WARNING}  -source 2
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../adi-hdl/library"] [file normalize "$origin_dir/../../ip_repo/common"] [file normalize "$origin_dir/../../ip_repo/low"]" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/adrv9364z7020_constr.xdc"]"\
 "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/adrv9364z7020_constr_lvds.xdc"]"\
 "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/ccbob_constr.xdc"]"\
]
...
set file "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/adrv9364z7020_constr.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/adrv9364z7020_constr_lvds.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../adi-hdl/projects/adrv9364z7020/common/ccbob_constr.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg400-1 -flow {Vivado Synthesis 2017} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2017} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
