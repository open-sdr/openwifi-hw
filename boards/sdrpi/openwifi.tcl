...
# Chaochen Wei. 1530604142@qq.com; modify the file to Relocate .xdc and top files.
# 
# openwifi.tcl: Tcl script for re-creating project
#
# Generated by Vivado on Wed Apr 22 20:57:18 CEST 2020
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/dcp/sdrpi_gpsdo_ether_eeprom.dcp"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/async_fifo_riffa.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/cdc.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/cdc_rx_incoming.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/clk_wiz_v3_6.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/por_rst.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/rcv_socket.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/regs.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/sdrpi_gpsdo_socket_eeprom.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/sdrpi_gpsdo_udp_eeprom.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/snd_socket.v"] \
 [file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/rtl/generic_fifo_dc_gray.v"] \
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/UDP_GPSDO_FOR_SDRPI/dcp/sdrpi_gpsdo_ether_eeprom.dcp"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "${origin_dir}/UDP_GPSDO_FOR_SDRPI/xdc/sdrpi_pin.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "${origin_dir}/UDP_GPSDO_FOR_SDRPI/xdc/sdrpi_pin.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
