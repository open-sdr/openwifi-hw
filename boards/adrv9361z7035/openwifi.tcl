...
#
# Generated by Vivado on Mon Nov 14 08:28:08 CET 2022
...
set _xil_proj_name_ "openwifi_adrv9361z7035"
...
set file "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9361z7035/common/adrv9361z7035_constr.xdc"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9361z7035/common/adrv9361z7035_constr_lvds.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../adi-hdl/projects/adrv9361z7035/common/ccbob_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z035ifbg676-2L -flow {Vivado Implementation 2021} -strategy "Performance_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
#jitter balanced 
startgroup
if {$NUM_CLK_PER_US == 200} {
  set_property -dict [list CONFIG.JITTER_SEL {No_Jitter} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200} CONFIG.MMCM_DIVCLK_DIVIDE {1} CONFIG.MMCM_BANDWIDTH {OPTIMIZED} CONFIG.MMCM_CLKFBOUT_MULT_F {25} CONFIG.MMCM_CLKOUT0_DIVIDE_F {5} CONFIG.CLKOUT1_JITTER {158.299} CONFIG.CLKOUT1_PHASE_ERROR {191.950}] [get_bd_cells clk_wiz_0]
} elseif {$NUM_CLK_PER_US == 100} {
  set_property -dict [list CONFIG.JITTER_SEL {No_Jitter} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {100} CONFIG.MMCM_DIVCLK_DIVIDE {2} CONFIG.MMCM_BANDWIDTH {OPTIMIZED} CONFIG.MMCM_CLKFBOUT_MULT_F {45} CONFIG.MMCM_CLKOUT0_DIVIDE_F {9} CONFIG.CLKOUT1_JITTER {274.086} CONFIG.CLKOUT1_PHASE_ERROR {305.681}] [get_bd_cells clk_wiz_0]
} else {
  throw {NUM_CLK_PER_US MUST BE 200 or 100. For other values, please add support in this if ... else ... conditions.}
}
endgroup
