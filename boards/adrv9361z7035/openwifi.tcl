...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../adi-hdl/library"] [file normalize "$origin_dir/../../ip_repo/common"] [file normalize "$origin_dir/../../ip_repo/big"] [file normalize "$origin_dir/../../ip_repo/high"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z035ifbg676-2L -flow {Vivado Synthesis 2018} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z035ifbg676-2L -flow {Vivado Implementation 2018} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
