...
module fifo64_1clk_dep64
   (CLK,
    ...
    WREN,
    data_count);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN fifo64_1clk_dep64_CLK, FREQ_HZ 200000000, INSERT_VIP 0, PHASE 0.000" *) input CLK;
