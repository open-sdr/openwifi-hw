...
module fifo32_2clk_dep32
  ...
  output EMPTY;
  output FULL;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RDCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RDCLK, CLK_DOMAIN fifo32_2clk_dep32_RDCLK, FREQ_HZ 200000000, PHASE 0.000" *) input RDCLK;
  input RDEN;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.WRCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.WRCLK, CLK_DOMAIN fifo32_2clk_dep32_WRCLK, FREQ_HZ 200000000, PHASE 0.000" *) input WRCLK;
  input WREN;
