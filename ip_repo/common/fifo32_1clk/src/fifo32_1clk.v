...
module fifo32_1clk
   (CLK,
    ...
    WREN,
    data_count);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN fifo32_1clk_CLK, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input CLK;
  output [31:0]DATAO;
  input [31:0]DI;
  output EMPTY;
  output FULL;
