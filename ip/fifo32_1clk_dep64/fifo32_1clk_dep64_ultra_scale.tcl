...
#
# fifo32_1clk_dep64.tcl: Tcl script for re-creating project 'fifo32_1clk_dep64'
#
...
#
# 1. This project restoration tcl script (fifo32_1clk_dep64.tcl) that was generated.
#
...
#
#    "ip/fifo32_1clk_dep64/bd/fifo32_1clk_dep64.bd"
#
#*****************************************************************************************
...
set project_name "fifo32_1clk_dep64"
...
set script_file "fifo32_1clk_dep64_ultra_scale.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo32_1clk_dep64"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo32_1clk_dep64.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo32_1clk_dep64.bd"
