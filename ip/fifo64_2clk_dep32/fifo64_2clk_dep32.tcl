...
#
# fifo64_2clk_dep32.tcl: Tcl script for re-creating project 'fifo64_2clk_dep32'
#
...
#
# 1. This project restoration tcl script (fifo64_2clk_dep32.tcl) that was generated.
#
...
#
#    "openwifi-hw/zc706_fmcs2/ip/fifo64_2clk_dep32/bd/fifo64_2clk_dep32.bd"
#
#*****************************************************************************************
...
set project_name "fifo64_2clk_dep32"
...
set script_file "fifo64_2clk_dep32.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo64_2clk_dep32"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo64_2clk_dep32.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo64_2clk_dep32.bd"
