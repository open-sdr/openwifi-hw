...
#
# fifo32_1clk_dep32.tcl: Tcl script for re-creating project 'fifo32_1clk_dep32'
#
...
#
# 1. This project restoration tcl script (fifo32_1clk_dep32.tcl) that was generated.
#
...
#
#    "ip/fifo32_1clk_dep32/bd/fifo32_1clk_dep32.bd"
#
#*****************************************************************************************
...
set project_name "fifo32_1clk_dep32"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo32_1clk_dep32"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo32_1clk_dep32.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo32_1clk_dep32.bd"
