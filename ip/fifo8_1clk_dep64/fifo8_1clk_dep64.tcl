...
#
# fifo8_1clk_dep64.tcl: Tcl script for re-creating project 'fifo8_1clk_dep64'
#
...
#
# 1. This project restoration tcl script (fifo8_1clk_dep64.tcl) that was generated.
#
...
#
#    "openwifi-hw/zc706_fmcs2/ip/fifo8_1clk_dep64/bd/fifo8_1clk_dep64.bd"
#
#*****************************************************************************************
...
set project_name "fifo8_1clk_dep64"
...
set script_file "fifo8_1clk_dep64.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo8_1clk_dep64"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo8_1clk_dep64.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo8_1clk_dep64.bd"
