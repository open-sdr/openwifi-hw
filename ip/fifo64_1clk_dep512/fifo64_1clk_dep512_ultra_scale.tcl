...
#
# fifo64_1clk_dep512.tcl: Tcl script for re-creating project 'fifo64_1clk_dep512'
#
...
#
# 1. This project restoration tcl script (fifo64_1clk_dep512.tcl) that was generated.
#
...
set project_name "fifo64_1clk_dep512"
...
set script_file "fifo64_1clk_dep512.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo64_1clk_dep512"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo64_1clk_dep512.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo64_1clk_dep512.bd"
