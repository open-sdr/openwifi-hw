...
set script_file "xpu_ultra_scale.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/xpu_ultra_scale"]"
...
set files [list \
 "[file normalize "$origin_dir/../../ip_repo/ultra_scale/fifo8_1clk_dep64/src/fifo8_1clk_dep64_fifo_generator_0_0/fifo8_1clk_dep64_fifo_generator_0_0.xci"]"\
 ...
 "[file normalize "$origin_dir/../../ip_repo/ultra_scale/fifo8_1clk_dep64/src/fifo8_1clk_dep64.v"]"\
...
set file "$origin_dir/../../ip_repo/ultra_scale/fifo8_1clk_dep64/src/fifo8_1clk_dep64_fifo_generator_0_0/fifo8_1clk_dep64_fifo_generator_0_0.xci"
...
set file "$origin_dir/../../ip_repo/ultra_scale/fifo8_1clk_dep64/src/fifo8_1clk_dep64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
