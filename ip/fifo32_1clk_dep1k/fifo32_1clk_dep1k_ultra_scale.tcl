...
#
# fifo32_1clk_dep1k.tcl: Tcl script for re-creating project 'fifo32_1clk_dep1k'
#
...
#
# 1. This project restoration tcl script (fifo32_1clk_dep1k.tcl) that was generated.
#
...
#
#    "openwifi-hw/zc706_fmcs2/ip/fifo32_1clk_dep1k/bd/fifo32_1clk_dep1k.bd"
#
#*****************************************************************************************
...
set project_name "fifo32_1clk_dep1k"
...
set script_file "fifo32_1clk_dep1k.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo32_1clk_dep1k"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo32_1clk_dep1k.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo32_1clk_dep1k.bd"
