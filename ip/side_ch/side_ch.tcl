...
set file "$origin_dir/../../ip_repo/common/fifo64_1clk_dep4k/src/fifo64_1clk_dep4k_fifo_generator_0_0/fifo64_1clk_dep4k_fifo_generator_0_0.xci"
...
set file "$origin_dir/../../ip_repo/common/fifo32_1clk_dep64/src/fifo32_1clk_dep64_fifo_generator_0_0/fifo32_1clk_dep64_fifo_generator_0_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
set file "$origin_dir/../../ip_repo/common/fifo32_1clk_dep64/src/fifo32_1clk_dep64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
