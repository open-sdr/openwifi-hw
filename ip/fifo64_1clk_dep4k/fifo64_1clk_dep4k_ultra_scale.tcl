...
#
# fifo64_1clk_dep4k.tcl: Tcl script for re-creating project 'fifo64_1clk_dep4k'
#
...
#
# 1. This project restoration tcl script (fifo64_1clk_dep4k.tcl) that was generated.
#
...
#
#    "ip/fifo64_1clk_dep4k/bd/fifo64_1clk_dep4k.bd"
#
#*****************************************************************************************
...
set project_name "fifo64_1clk_dep4k"
...
set script_file "fifo64_1clk_dep4k.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fifo64_1clk_dep4k"]"
...
set files [list \
 "[file normalize "$origin_dir/bd/fifo64_1clk_dep4k.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/bd/fifo64_1clk_dep4k.bd"
