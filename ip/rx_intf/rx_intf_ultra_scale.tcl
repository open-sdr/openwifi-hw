...
# set_property "ip_repo_paths" "[file normalize "$origin_dir/../../ip_repo/ultra_scale/rx_intf"]" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../ip_repo/ultra_scale/fifo32_1clk_dep32/src/fifo32_1clk_dep32.v"]"\
...
set file "$origin_dir/../../ip_repo/ultra_scale/fifo32_1clk_dep32/src/fifo32_1clk_dep32.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
