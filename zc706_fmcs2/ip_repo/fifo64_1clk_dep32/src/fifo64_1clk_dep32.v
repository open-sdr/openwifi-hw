...
(* CORE_GENERATION_INFO = "fifo64_1clk_dep32,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fifo64_1clk_dep32,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "fifo64_1clk_dep32.hwdef" *) 
module fifo64_1clk_dep32
   (CLK,
    DATAO,
    DI,
    EMPTY,
  ...
  fifo64_1clk_dep32_fifo_generator_0_0 fifo_generator_0
       (.clk(CLK_1),
