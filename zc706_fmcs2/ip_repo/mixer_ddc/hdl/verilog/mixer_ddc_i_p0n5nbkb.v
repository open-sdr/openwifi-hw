...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module mixer_ddc_i_p0n5nbkb_rom (
...
initial begin
    $readmemh("./mixer_ddc_i_p0n5nbkb_rom.dat", ram0);
    $readmemh("./mixer_ddc_i_p0n5nbkb_rom.dat", ram1);
    $readmemh("./mixer_ddc_i_p0n5nbkb_rom.dat", ram2);
end
...
mixer_ddc_i_p0n5nbkb_rom mixer_ddc_i_p0n5nbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
