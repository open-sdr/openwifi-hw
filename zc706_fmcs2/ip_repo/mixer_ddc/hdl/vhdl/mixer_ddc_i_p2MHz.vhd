...
entity mixer_ddc_i_p2MHz_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of mixer_ddc_i_p2MHz_rom is 
...
architecture arch of mixer_ddc_i_p2MHz is
    component mixer_ddc_i_p2MHz_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mixer_ddc_i_p2MHz_rom_U :  component mixer_ddc_i_p2MHz_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
